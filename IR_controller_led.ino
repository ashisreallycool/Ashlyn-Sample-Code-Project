...
long codes[14]=             // this array is used to store infrared codes
{
...
void loop() {
  if (irrecv.decode(&results)) {
      for(int i = 0; i <= 13; i++){
         ...
         //
         else if(results.value == codes[11]&& !(currentNumber >=5)){
               currentNumber = currentNumber*2;
               numberShow(currentNumber);
               Serial.println(currentNumber);
               break;
         ...
         else if(results.value == codes[12]&& currentNumber !=9 ){
               currentNumber++;
               numberShow(currentNumber);
               Serial.println(currentNumber);
               break;
         ...
         else if(results.value == codes[13]&& currentNumber !=0 ){
               currentNumber--;
               numberShow(currentNumber);
               Serial.println(currentNumber);
               break;
